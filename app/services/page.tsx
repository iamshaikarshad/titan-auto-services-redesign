...
const serviceDetails: Record<ServiceKey, ServiceDetail> = {
  ...
  aircon: {
    ...
    bookingLabel: 'Book Repairs',
    features: ['All Makes', 'Minor Repairs', 'Major Repairs', 'Quality Parts'],
    rows: [
      { label: 'Minor repair / fix', value: 'From £40' },
      { label: 'Electrical fault diagnosis', value: 'From £50' },
      { label: 'Bodywork / panel repair', value: 'From £80' },
      { label: 'General maintenance', value: 'From £60' },
      { label: 'Custom repair work', value: 'Get a quote' },
    ],
